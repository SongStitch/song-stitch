...
var ErrTooManyTracks = errors.New("too many tracks")
...
func collage(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		case err == ErrTooManyTracks:
			http.Error(w, "Requested collage size is too large for tracks.", http.StatusBadRequest)
		default:
