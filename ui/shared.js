    ...
    <footer class="footer">
      ...
      <div class="footer-meta">
        <span class="footer-text">
          Made with &#10084;&#65039; by
          <a class="href-links" href="${getContributorLink(names[0])}" target="_blank" rel="noopener">${names[0]}</a>
          &amp;
          <a class="href-links" href="${getContributorLink(names[1])}" target="_blank" rel="noopener">${names[1]}</a>
        </span>
